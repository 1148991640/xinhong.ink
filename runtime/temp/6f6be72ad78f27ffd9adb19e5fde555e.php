<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"D:\phpStudy\PHPTutorial\WWW\xinhong.ink\public/../application/admin\view\admin\all.html";i:1589899270;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
    ...
    <div class="panel-head"><strong class="icon-reorder"> 管理员列表</strong></div>
      <div class="padding border-bottom">
          <button type="button" class="button border-yellow" onclick="location.href='<?php echo url('add'); ?>'">
              <span class="icon-plus-square-o"></span> 新增管理员</button>
      </div>
