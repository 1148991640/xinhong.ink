<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"D:\phpStudy\PHPTutorial\WWW\Servers\public/../application/admin\view\category\all.html";i:1584269163;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
    ...
    <table class="table table-hover text-center">
     ...
     <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        <tr>
            ...
            <td><img src="/Servers/public/Uploads/<?php echo $vo['pic']; ?>" width="60"></td>
          <td>
