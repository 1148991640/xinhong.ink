<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"D:\phpStudy\PHPTutorial\WWW\Servers\public/../application/admin\view\orders\all.html";i:1587351306;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
    ...
    <table class="table table-hover text-center">
     ...
     <?php endforeach; endif; else: echo "" ;endif; ?>
      <tr style="padding-left:40px;">
          ...
          <td colspan="6" style="padding-left:40px;text-align: left">数据随时更新，下面是目前的统计数据</td>
      </tr>
        <tr style="padding-left:40px;">
            <td colspan="4">已完成订单数量：<span></span></td>
            <td colspan="6" style="padding-left:40px;text-align: left">金额总额：<span></span></td>
        </tr>
      <tr>
        <td colspan="10">
            <div class="pagelist">
