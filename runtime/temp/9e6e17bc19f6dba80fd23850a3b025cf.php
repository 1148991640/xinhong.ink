<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"/www/wwwroot/xinhong.ink/public/../application/admin/view/goods/edit.html";i:1587545907;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
      ...
      <form method="post" class="form-x"  enctype="multipart/form-data">
          ...
          <div class="form-group">
              ...
              <div class="field">
                  ...
                  原图：<img src="//Uploads/<?php echo $info['pic']; ?>" width="55">
                  <div class="tips"></div>
              </div>
          </div>
          <div class="form-group">
